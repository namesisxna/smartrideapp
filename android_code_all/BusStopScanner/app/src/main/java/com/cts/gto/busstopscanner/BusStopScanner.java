package com.cts.gto.busstopscanner;
...
public class BusStopScanner extends Activity {
	...
	public void scanBar(View v) {
		try {
			...
			showDialog(BusStopScanner.this, "No Scanner Found", "Download a scanner code activity?", "Yes", "No").show();
		}
	}
		...
		if (requestCode == 0) {
			if (resultCode == RESULT_OK) {
				...
				if(bookType.charAt(0)=='T'){
					...
					textView.setText("Booking is being confirmed with "+"bookingNumber :"+bookNum);
				}

				else if (bookType.charAt(0)=='C' && offboardStop.equals(destinationStopId)){
					TextView textView = (TextView) findViewById(R.id.textView3);
					textView.setText("You have reached your destination. Your net balance is being credited back to your wallet");
				}
